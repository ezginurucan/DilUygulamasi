...
class SampleApp(tk.Tk):
    ...
    def __init__(self):
        ...
        self.iconbitmap(r"C:\Users\LENOVO\Desktop\Book-icon.ico")
        self._frame = None
...
class StartPage(tk.Frame):
    def __init__(self, master):
        ...
        image = Image.open(r"C:\Users\LENOVO\Desktop\Welcome.png")
        canvas_for_image.image = ImageTk.PhotoImage(image.resize((600, 200), Image.ANTIALIAS))
        canvas_for_image.create_image(0, 0, image=canvas_for_image.image, anchor='nw')



        Level_1_img = Image.open(r"C:\Users\LENOVO\Desktop\Level 1.png")
        ...
        Level_2_img = Image.open(r"C:\Users\LENOVO\Desktop\Level 2.png")
        ...
        Level_3_img = Image.open(r"C:\Users\LENOVO\Desktop\Level 3.png")
        ...
        Level_4_img = Image.open(r"C:\Users\LENOVO\Desktop\Level 4.png")
        ...
        Level_5_img = Image.open(r"C:\Users\LENOVO\Desktop\Level 5.png")
        ...
        Level_6_img = Image.open(r"C:\Users\LENOVO\Desktop\Level 6.png")
    ...
    def eslestir_sec(self, y, z):
        ...
        if len(a) == 2:
            ...
            if a[0] == yeni.keys():
                ...
                if (type(yeni[a[1]]) == list and a[0] == yeni[a[1]]) or a[0] == yeni[a[1]]:
                    b[0].config(state="disable")
                    b[1].config(state="disable")
                    self.Check = Label(self, text="\t\t\t\t", background="pink",font=('Pursia', 14, "bold"))
                    self.Check.grid(row=7, column=0, pady=5, padx=5,sticky=E)
